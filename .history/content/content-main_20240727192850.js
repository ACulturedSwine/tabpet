...
let pasteType = 'food';
const interactableContainer = createInteractableContainer();
...
function bindPaste() {
    document.addEventListener('paste', (e) => handleInteractableImg(e));
}

async function handleInteractableImg(e) {
