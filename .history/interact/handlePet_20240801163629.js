...
import { samplePetInfo, getPetInfo } from '/utils/pet-info.js';
...
function createPet() {
    return new Promise(async (resolve)=> {
        ...
        if (urlParams && urlParams.testingNewTab) {
            petInfo = samplePetInfo;
        }
        else {
            petInfo = await getPetInfo();
            console.log('pet info from storage', petInfo);
