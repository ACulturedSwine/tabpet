class Cursor {
    constructor() {
        ...
        this.y = null;
        this.track();
        this.updatePos = this.updatePos.bind(this); // Bind updatePos to this
    }
    ...
    updatePos(e) { // Has to be public to be binded
        this.x = e.clientX;
        this.y = e.clientY;
    }

    track() {
        document.addEventListener('mousemove', this.updatePos.bind(this)); // Bind this so class is updated in callback
    }

    stopTrack() {
        document.removeEventListener('mousemove', this.updatePos.bind(this));
    }
}
