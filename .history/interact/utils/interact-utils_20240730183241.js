...
function isAt(a, b) { // Given two items a and b (can be either element or point), return information on if a and b are touching and where b is in relation to a.
