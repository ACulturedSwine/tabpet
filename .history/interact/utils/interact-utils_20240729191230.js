function waitUntilInteractableImgLoaded(pasteID) {
    return new Promise((resolve)=> {
        document.addEventListener('interactable:img-loaded', ()=> {
...
export { waitUntilImgLoaded, overlaps, resetCursor, setCursor, isInside };