...
function isTouching(a, b) { // Returns object on if a and b are touching and where b is in relation to a.
    ...
    const above = aDims.bottom < bDims.top;
    const below = aDims.top > bDims.bottom;
...
export { isInteractable, isFood, waitUntilImgLoaded, isTouching, resetCursor, setCursor, isInside };