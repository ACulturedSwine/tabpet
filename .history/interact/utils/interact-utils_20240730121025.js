...
function isTouching(a, b) {
    ...
    const moveLeft = aDims.left > bDims.right;
    const moveRight = aDims.right < bDims.left;
    const moveUp = aDims.top > bDims.bottom;
    const moveDown = aDims.bottom < bDims.top;
    
    const touching = !(moveRight || !moveLeft || !moveUp || !moveDown);
