...
function isTouching(a, b) { // Given two elements a and b, provides information on if a and b are touching and where b is in relation to a.
...
export { isInteractableEl, isInteractable, isFood, waitUntilImgLoaded, isTouching, resetCursor, setCursor, isPosInsideEl };