...
function createInteractableContainer() {
    ...
    */
    const chromeTaskbarHeight = document.body.scrollHeight - window.innerHeight;
    console.log(chromeTaskbarHeight);

    const standardWidth = screen.availWidth;
    const standardHeight = screen.availHeight - chromeTaskbarHeight;
