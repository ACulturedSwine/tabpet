...
async function handlePaste(e) {
    ...
    const position = await isPosInsideEl(cursor.pos, interactContainer); // Returns relative position if cursor is inside container
    if (!position) {
    ...
    const type = pasteType;
    const containerEl = interactContainer;
