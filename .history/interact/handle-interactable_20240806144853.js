...
async function handlePaste(e) {
    ...
    if (!isColliding(cursor.pos, interactContainer)) return;
    const relativePosition = getRelativePosition(cursor.pos, interactContainer); // Returns relative position if cursor is inside container
    if (!position) {
    ...
    createInteractable(pasteType, src, position, interactContainer);
