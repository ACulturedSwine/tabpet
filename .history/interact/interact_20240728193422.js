...
function handleInteract() {
    document.addEventListener('click', (e)=> {
        let interactableEl = e.target;
        const parentEl = el.parentElement;
        if (!el.classList.contains('interactable')) { // Check if parent element is container for interactable
            if (parentEl && parentEl.contains('interactable')) interactableEl = parentEl;
            else return;
        }
