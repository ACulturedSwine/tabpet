...
class Interactable {
    constructor(type, src, position, containerEl) {
        ...
        if (type !== 'food') { // Types that don't have their own initEl
...
class Food extends Interactable {
    ...
    initEl(src, position) { // Overwritten method
        ...
        image.src = 'https://images.immediate.co.uk/production/volatile/sites/30/2017/01/Bunch-of-bananas-67e91d5.jpg?quality=90&resize=440,400'; // Replace with your image URL
...
export { InteractableManager, Interactable, Food };