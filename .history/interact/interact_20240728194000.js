...
function handleInteract() {
    document.addEventListener('click', (e)=> {
        ...
        // Check if selected element is interactable or has interactable parent element
        if (el.classList.contains('interactable')) interactableEl = el;
        else if (parentEl && parentEl.classList.contains('interactable')) interactableEl = parentEl;
        else return;
...
function isInteractable(el) { // Recursive function, returns true if is interactable or child of interactable
    if (el.classList.contains('interactable')) return true;
