...
function createInteractableContainer() {
    ...
    */
    ...
    const offset = screen.availHeight - window.outerHeight;
    console.log(screen.availHeight, window.outerHeight, offset);

    const standardWidth = screen.availWidth;
    const standardHeight = document.body.scrollHeight;
