...
function createInteractableContainer() {
    ...
    const offset = screen.height - screen.availHeight;

    const standardWidth = screen.availWidth;
    const standardHeight = screen.availHeight - offset * 2; // TODO: Get maximum height of window (screen.availHeight includes chrome taskbar)
