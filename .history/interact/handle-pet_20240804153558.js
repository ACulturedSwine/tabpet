...
import { getCreatedElement, onMouseRelease, isColliding } from '/utils/content-utils.js';
...
function createHeartParticles() {
    ...
    if (isColliding(cursor, pet.hitboxEl)) createParticles('heart', cursor.pos, interactContainer);
}
