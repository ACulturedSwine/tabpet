class Cursor {
    ...
    track() {
        const self = this;
        document.addEventListener('mousemove', self.updatePos.bind(this)); // Bind this so class is updated in callback
    }

    stopTrack() {
        const self = this;
        document.removeEventListener('mousemove', self.updatePos.bind(this));
    }
