...
export default async function handleTutorial() {
    ...
    await createPopupMsg({content: `To see your pet's profile, click 🐹 at the top left corner.`, waitTime: 2000});
    await createPopupMsg({content: `To download your pet's data, click ⬇️ at the top left corner.`, waitTime: 2000});
    await createPopupMsg({content: 'Downloading your data will be important if you want to keep up with extension updates!', waitTime: 2000});
