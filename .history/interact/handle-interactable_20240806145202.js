...
import { isColliding, getRelativePositionIfColliding } from '../utils/collision.js';
...
async function handlePaste(e) {
    ...
    const relativePosition = getRelativePositionIfColliding()
    if (!isColliding(cursor.pos, interactContainer)) {
    ...
    createInteractable(pasteType, src, getRelativePosition(cursor.pos, interactContainer), interactContainer);
