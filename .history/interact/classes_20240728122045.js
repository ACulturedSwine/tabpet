class Interactable {
    ...
    #positionCentered(x, y) { // Positions element centered at (x, y), adjust center if overlaps any border(s) of container
        ...
        else if (newX > containerDimensions.width) newX = containerDimensions.width - elDimensions.width; // Past right border
        if (newY > 0) newY = 0; // Past top border
        else if (newY > containerDimensions.height) newY = containerDimensions.height; // Past bottom border
