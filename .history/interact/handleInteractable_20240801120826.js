...
function createInteractableContainer() {
    ...
    */
    // console.log(window.outerHeight, window.innerHeight, document.body.scrollHeight, window.outerHeight - window.innerHeight);
    const standardWidth = screen.availWidth;
    const standardHeight = mainDiv.offsetHeight * zoomLevel;
