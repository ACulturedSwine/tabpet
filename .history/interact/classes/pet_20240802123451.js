...
class Pet {
    ...
    animEmote(type, params={time: 1, timeFunc: 'cubic-bezier(0.175, 0.885, 0.32, 1.275)'}) {
        const { time, timeFunc } = params.time;
        const timeFunc = params.timeFunc;
        this.emoteEl.style.animation = ``;
    }
