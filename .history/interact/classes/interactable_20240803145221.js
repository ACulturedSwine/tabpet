import * as Food from '/utils/food-utils.js';
import { sendEvent } from '/utils/content-utils.js';

class Interactable {
    constructor(params={}) {
        const { type, src, position, containerEl, pasteID, size } = params;
        // Set basic attributes
        this.type = type;
        this.containerEl = containerEl;
        this.size = size || {width: 100};

        // If Interactable has image, set img as img el or Image and set imgLoaded as true when loaded (done in createEl)
        this.hasImg = true;
        this.img = null;
        ...
        // Set pasteID for handling in handleInteractable.js
    ...
    eat() { // Creates bite. Returns true if finished, returns false if can eat more.
        ...
        if (finished) sendEvent('remove-interactable', { pasteID: this.pasteID });
    ...
    #createImgEl(src) {
        ...
        // Update imgLoaded to true when image loaded
        const self = this;
