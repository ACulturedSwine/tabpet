...
class Pet {
    constructor(createParams, personalInfo) {
        ...
        this.poses = PetUtils.getPoses(type, subtype);
    ...
    pose(pose) {
        this.imgEl.src = chrome.runtime.getURL(`/assets/${type}/${subtype}/${pose}.png`);
    }
    ...
    #createEls(params) { // Create elements of pet, return outermost element
        ...
        this.imgEl = PetUtils.createImgEl(params.type, params.subtype, this.pose);
