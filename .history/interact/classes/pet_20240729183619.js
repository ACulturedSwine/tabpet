...
class Pet {
    ...
    eat(foodObj) {
        ...
        let loopID = setInterval(function() {
            ...
            if (finished) {
                sendEvent('remove-interactable', { pasteID: foodObj.pasteID });
    ...
    #createEls(params) { // Create elements of pet, return outermost element
        ...
        // Chain append with first element innermost element and moveEl as outermost element. Return outermost element when done.
        const outerEl = PetUtils.chainAppend([this.animEl, this.flipEl, this.moveEl]);
