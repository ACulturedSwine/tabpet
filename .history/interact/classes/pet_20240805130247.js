...
class Pet {
    ...
    handleExitContainer() {
        ...
        if (!this.exitedContainer && !inContainer) createPopupMsg({content: `${this.petInfo.firstName} is playing hide and seek!`});
        this.exitedContainer();
        if (!this.isInContainer() && !this.exitedContainer) {
            this.exitedContainer = true;
