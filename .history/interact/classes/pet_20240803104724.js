...
class Pet {
    ...
    #createEls(params) { // Create elements of pet, return outermost element
        ...
        this.flipSide = params.flipSide || -1; // this.randomFlipSide(); // Either 1 or -1. 1 means facing right, -1 means facing left.
        ...
        this.flipEmoteContent(); // Flip emote content correctly
