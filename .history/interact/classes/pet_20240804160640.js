...
class Pet {
    ...
    setMoodConstants(createParams) {
        this.breathTime = createParams.breathTime || 2;
    }
    ...
    relax(decrement=0.2) {
        ...
        this.activeLvl -= decrement;
        this.breathTime -= decrement;
    }

    animate(anim, animTime) {
        this.style.animation = `${anim} ${animTime}s cubic-bezier(0.280, 0.840, 0.420, 1) infinite`;
    }
    ...
    #createEls(params) { // Create elements of pet, return outermost element
        ...
        this.animEl = PetUtils.createAnimEl(this.anim, this.animTime);
