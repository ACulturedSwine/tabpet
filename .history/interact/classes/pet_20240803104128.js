...
class Pet {
    ...
    flip() {
        ...
        // Ensure emote content doesn't flip
        this.emote.contentEl.style.transform = `scaleX(${this.flipSide})`;
    }
    ...
    #createEls(params) { // Create elements of pet, return outermost element
        ...
        this.flipSide = params.flipSide || this.randomFlipSide(); // Either 1 or -1. 1 means facing right, -1 means facing left.
