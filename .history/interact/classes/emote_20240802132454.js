import { randomFromRange, randomFromArray, randomKeyFromObject } from '/utils/general-utils.js';
import { wait } from '/utils/content-utils.js';

class Emote {
    constructor() {
        this.createEl();
        this.emojiCategories = this.createEmojis();
    }
    ...
    randomEmoji() {
        return randomFromArray(randomFromArray(this.emojiCategories));
    }
