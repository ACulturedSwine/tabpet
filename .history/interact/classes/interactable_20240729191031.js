...
class Interactable {
    constructor(type, src, position, containerEl, pasteID, size) {
        ...
        // Initialize element
        this.el = this.createEl(src, pasteID); // If Interactable has image, when img loaded must update imgLoaded and send event
    ...
    #createFoodEl(src, pasteID) {
        ...
        img.addEventListener('load', ()=> {
            this.imgLoaded = true;
            sendEvent('interactable:img-loaded', {pasteID: pasteID});
