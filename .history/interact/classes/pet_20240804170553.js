...
class Pet {
    ...
    displayActiveType() {
        console.log('active type', this.activeType, 'breath time', this.breathTime);
    ...
    excite(change) {
        ...
        this.breathTime = Math.min(this.breathTime - change, minBreathTime);
        if (this.breathTime <= minBreathTime)
        

        const maxBreathTime = this.activeIndex['relaxed'].breathTime;
        this.breathTime = Math.min(this.breathTime + change, maxBreathTime);
        if (this.breathTime >= maxBreathTime) this.setActiveType('relaxed');
