...
class Pet {
    constructor(createParams, petInfo) {
        ...
        this.emote.emote({content: this.emote.randomEmoji('special', 'food')});
    }
    ...
    eat(food) {
        ...
        return new Promise((resolve)=> {
            // Food emote
            pet.emote.emote({content: this.randomEmoji('special', 'food')});
    ...
    #createEls(params) { // Create elements of pet, return outermost element
        ...
        this.rigidEl.appendChild(this.emote.containerEl);
