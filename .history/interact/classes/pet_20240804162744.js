...
class Pet {
    ...
    initActiveLvlConstants() {
        this.activeLvls = { // Number correlates with breathing rate (how fast the animation is). Higher number = less active.
            2: {name: 'active', anim: 'squish'},
            4: {name: 'relaxed', anim: 'smoosh'}
        }
    }
