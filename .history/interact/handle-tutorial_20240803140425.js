...
export default async function handleTutorial() {
    ...
    await createPopupMsg({content: `To see your pet's profile, click their  at the top left corner.`, waitTime: 5000});
    await createPopupMsg({content: `To download your pet's data, click ⬇️ at the top left corner.`, waitTime: 5000});
    await createPopupMsg({content: '💡 You will need to download your data before updating the extension.', waitTime: 5000});
