...
document.addEventListener('DOMContentLoaded', ()=> {
    ...
    const searchProfilePhoto = document.querySelector('.gb_p.gbii');
    ...
    waitForEl('.some-class').then((elm) => {
        const expandedProfileContainer = document.querySelectorAll('iframe[name="account"]');
