...
function handleTogglePetProfileWindow(icon, panel) {
    hidePetProfileWindow(icon, panel);
}
...
function showPetProfileWindow(icon, panel) {
    panel.isOpen = true;
...
function hidePetProfileWindow(icon, panel) {
    panel.isOpen = false;
    icon.addEventListener('click', function() {
        console.log('open');
        showPetProfileWindow(icon, panel);
    }, {once: true});
}