...
function handleTogglePetProfileWindow(icon, window) {
    petProfileIcon.addEventListener('click', (icon, window)=> showPetProfileWindow(icon, window));
}
...
function showPetProfileWindow(petProfileIcon, petProfileWindow) {

}

function hidePetProfileWindow(petProfileIcon, petProfileWindow) {
