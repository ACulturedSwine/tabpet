...
function hasSearch() { // If haven't initially clicked in search bar or text in search bar, "Trending searches" will not show.
    return trendingSearchesDiv === null || !trendingSearchesDiv.textContent;
}
