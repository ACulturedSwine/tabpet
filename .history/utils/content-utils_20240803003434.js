...
function appendChildren(parentEl, childEls) {
    for (let childEl in childEls) parentEl.appendChild(childEl);
}
...
export { sendEvent, removeElement, removeAllChildElements, removeAllEventListeners, createIDElement, appendChildren, chainAppend, getCreatedElement, getInteractContainer, wait };