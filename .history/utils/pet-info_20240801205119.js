...
function getSpriteSrc(type, subtype, pose='side', origin='content-script') {
    ...
    if (origin === 'content-script') { // Content script needs to get url from chrome.runtime. Sometimes, chrome.runtime doesn't work in extension pages, so set origin to 'extension.'
