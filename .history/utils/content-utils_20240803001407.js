...
function appendChildren(parentEl, childEls) {
    for (childEl in childEls) parentEl.appendChild(childEl);
}
...
function createIDElement(type, content, ) {
...
export { sendEvent, removeElement, removeAllChildElements, removeAllEventListeners, appendChildren, chainAppend, getCreatedElement, getInteractContainer, wait };