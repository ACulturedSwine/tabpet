...
function onMouseRelease(el, whileHold, onRelease) { // Callback during mouse hold and callback after when mouse release
    el.addEventListener('mousedown', ()=> {
        const id = whileHold(); // Callback on hold must return setInterval id
