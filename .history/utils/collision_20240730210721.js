...
function getLeftRightTopBottom(param) { // Param is either point, element, or bounding client rect
    if (param.left && param.right && param.top && param.bottom && param.x && param.y) {
        return param;
    }
