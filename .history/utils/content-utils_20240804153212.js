...
function onMouseRelease(el, whileHold, onRelease, whileHoldUpdateTime) { // Function during mouse hold and function after when mouse release
    el.addEventListener('mousedown', ()=> {
        // While holding on same element
        const whileHoldInterval = setInterval(function() {
            whileHold();
        }, whileHoldUpdateTime);
        ...
        function handleMouseUp(e) {
            if (e.target === el) {
                clearInterval(whileHoldInterval); // Stop function while mouse hold
