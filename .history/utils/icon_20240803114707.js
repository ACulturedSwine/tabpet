...
function partOfIcon(el) { // Returns true if icon-image-container or icon-image
    return el.classList.contains('icon-image-container') ||  el.classList.contains('icon-image');
}
