...
function createEmoteEl() {
    const el = document.createElement('img');
    el.classList.add('emote');
    el.src = chrome.runtime.getURL('/assets/emote/speech/1.png');
    return el;
}

export { getPoses, chainAppend, createMoveEl, createFlipEl, createRigidEl, createAnimEl, createHitboxEl, createImgEl, createEmoteEl };