...
function capitalize(string) {
    return string[0].toUpperCase() + string.slice[0];
}

export { randomFromRange, randomIntFromRange, randomFromArray, randomKeyFromObject, randomAlphaString, chance, minAsMillisec, isNonEmptyObject };