...
class FormManager {
    ...
    */
    ...
    validateCurrentQuestions(currentPageEl) {  // Run through all questions and save if not blank (applies to required and optional questions).
        ...
        // Invalidate first incomplete answer (applies to required questions) and return if exists.
