...
function isInvalid(input) {
    ...
    console.log(input.getAttribute('aria-label'));
    console.log(ariaRequired);
    console.log('aria required = false or none' + (!ariaRequired || ariaRequired === 'false'));
    console.log('is blank' + input.value.trim() === '');
    console.log(('is invalid' + !ariaRequired || ariaRequired === 'false') || input.value.trim() === '');
    return false;
}