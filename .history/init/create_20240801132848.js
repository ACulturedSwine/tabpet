...
function handlePaging() {
    const pages = [
        ...
        new FormPage('done', 'Done', 'Go back to change your answers\nIf you are satisfied with your gerbil, click Next') // Last page has no title or description
    ];
...
function handleNext(pages) {
    ...
    nextButton.addEventListener('click', ()=> {
        ...
        if (isPageComplete) {
            ...
            // const lastFormPage = pageNum === pages.length && document.getElementById('form-finished-page'); // Last form page and page exists
            if (nextFormPage || lastFormPage) { 
...
function displayNewPage(pages, pageNum) {
    ...
    if (false) { // Show last page if form finished
        document.getElementById('form-finished-page').style.display = 'block';
        document.getElementById('instructions-div').style.display = 'none';
        document.getElementById('inputs-div').style.display = 'none';
    }
    else { // Otherwise, show form page
        // Update instructions
        ...
        const descEl = document.getElementById('desc');
        const descLines = pageInfo.desc.split('\n');
        descLines()
        .textContent = pageInfo.desc;
