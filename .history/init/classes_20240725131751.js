...
class FormManager {
    ...
    */
    ...
    saveAnswersIfValid() {  // Run through all inputs and save if valid.
                            // Invalidate first required input that is blank and clear warning when input isn't blank.
        const questions = this.#getPageQuestions();
        let firstBlankRequiredAnswer = null;

        return firstBlankRequiredAnswer;
    }
