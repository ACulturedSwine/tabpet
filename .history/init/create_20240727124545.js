...
import { isValidImageURL } from '/edit/utils.js';
...
function handlePhotoUpload() {
    ...
    function setCustomPhoto(photo) {
        ...
        if (photo instanceof File) photoEl.src = window.URL.createObjectURL(photo);
        else if (typeof photo === 'string') photoEl.src = photo;
