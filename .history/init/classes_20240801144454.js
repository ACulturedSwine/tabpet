...
class FormManager {
    ...
    */
    ...
    async saveInput(questionEl, value) { // Value is used if question element has different value needed to be saved than its value attribute
        const label = questionEl.getAttribute('aria-label');
        let value = null;
