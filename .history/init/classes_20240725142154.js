...
class FormManager {
    ...
    */
    ...
    #remove(label) {
        ...
        this.#displayAsValid(this.info[label].el);
    ...
    #getQuestionIfLabel(x) { // If label, converts to question element. Else, returns HTML element.
