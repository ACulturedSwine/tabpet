    ...
    */
    ...
    checkCurrentQuestions(currentPageEl) {  
        ...
        questions.forEach(q=> {
            ...
            if (isBlank) {
                q.value = '';
                if (isRequired && firstIncompleteAnswer === null) {
                    console.log('this is incomplete and required!');
            ...
            console.log(firstIncompleteAnswer);
        });
    ...
    #isRequired(questionEl) {
        ...
        return ariaRequired || ariaRequired === 'true';
    }
