...
class FormManager {
    ...
    */
    ...
    checkCurrentQuestions(currentPageEl) {   // Run through all questions and save if not blank (applies to required and optional questions).
                                    // If blank and has white space, set question value to "".
                                // Invalidate first incomplete answer (applies to required questions).
        if (!currentPageEl) {
            throw new Error('Invalid current page element: please input and/or initialize');
        }
