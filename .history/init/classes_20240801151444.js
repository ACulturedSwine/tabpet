...
class FormManager {
    ...
    */
    ...
    #isInvalid(el) { // If invalid, return message describing why invalid.
        ...
        else if (el.maxLength != -1 && value.length > el.maxLength || el.minLength != -1 && value.length < el.minLength) { // Input is "number" type and isn't between minLength and maxlength (maxLength not built-in for number)
