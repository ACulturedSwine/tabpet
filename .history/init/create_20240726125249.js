...
function handlePhotoUpload() {
    ...
    selectPhoto.addEventListener('click', function() {
        console.log('click');
        if (lastSelectValue === 'Custom' && !isFileDialogOpen) { // Allow user to select 'Custom' multiple times consecutively
            photoUpload.click();
        }
        else if (!isFileDialogOpen && this.value !== lastSelectValue) {
