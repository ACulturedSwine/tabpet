...
function handleValidatePattern() {
    ...
    inputs.forEach((input)=> {
        let prevVal = '';
        input.addEventListener('input', function() { // for hard invalids, prevent user from changing input to invalid input (not blank)
            ...
            this.value = prevVal; // for invalid, prevent user from changing input to invalid input
        })
    })
}
