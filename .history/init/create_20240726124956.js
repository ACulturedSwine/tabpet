...
function handlePhotoUpload() {
    ...
    selectPhoto.addEventListener('click', function() { // Allow user to select 'Custom' multiple times consecutively
        if (lastSelectValue === 'Custom' && !isFileDialogOpen) {
            
        }
        else if (lastSelectValue !== 'Custom') {
